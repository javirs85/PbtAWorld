	...
	public void InitArchetype(USMovesService Moves)
	{
		...
		switch (Archetype)
		{
			...
			case US_Classes.Imp:
				...
				ArchetypeUniqueTittle1 = "Tus chanchullos";
				ArchetypeUniqueBody1 = "Los chanchullos son tratos arriesgados y engaños turbios diseñados para expandir tu negocio. Cuando generas un chanchullo, elige un Círculo principal, uno de tus servicios y dos complicaciones. El MC te dirá qué oportunidad has aprovechado. Al completar un chanchullo, selecciona dos beneficios y una ganancia; el MC detallará cómo se concretan. Genera un chanchullo siempre que un beneficio o un movimiento te indique generar uno nuevo.";
